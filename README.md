...
# in this project we will be cloning Airbnb and running all our functionality from the console
...
```bash
git clone https://github.com/Augustine-ebuka/AirBnB_clone.git
```
...
<details>
    ...
    <li><a href="https://www.github.com/YemiRebel">Github</a></li>
